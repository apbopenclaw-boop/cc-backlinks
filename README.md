...
backlinks(id, crawl_id, linking_domain, num_hosts)     -- UNIQUE(crawl_id, linking_domain)
```
...
4. **Prioritize:** Sort by `num_hosts` (authority proxy), filter for industry relevance
5. **Outreach:** Target gap domains for link-building
